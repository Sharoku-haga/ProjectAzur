...
public:
	...
	*/
	void RegisterPlayerCollider(ColliderBase* pPlayerCollider)
	{
...
private:
	...
	ColliderBase*								m_pPlayerCoolider;			//!< プレイヤーのColldierクラスのへのポインタ
	std::vector<ColliderBase*>					m_pStageObjColliders;		//!< ステージ上のオブジェクトのColliderへのポインタの動的配列
